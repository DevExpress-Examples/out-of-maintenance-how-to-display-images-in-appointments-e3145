        ...
        <div>
            <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" OnInitAppointmentImages="ASPxScheduler1_InitAppointmentImages" OnAppointmentInserting="ASPxScheduler1_AppointmentInserting">
                <Storage>
                    <Appointments>
                        <Labels>
                            <cc1:AppointmentLabel Color="255, 194, 190" DisplayName="Important" MenuCaption="&amp;Important" />
                            <cc1:AppointmentLabel Color="168, 213, 255" DisplayName="Business" MenuCaption="&amp;Business" />
                        </Labels>
                    </Appointments>
                </Storage>
